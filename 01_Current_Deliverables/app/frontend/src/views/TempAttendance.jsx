...
export default function TempAttendance() {
  ...
  const badPerson = p => (p.异常多记日次 > 0) || (p.待查日次 > 0)
        ...
        {step === 'import' && <>
          <div className="card ta-guide">
            ...
            <ul>
              ...
              <li><b>少记不追，多记才查。</b> 人力少记（工人少拿）财务可接受，只作提示、不要求补付；
                <b className="warn">超出弹性的多记＝公司多付钱，是唯一必须逐笔说明的一档。</b></li>
                ...
                {st.上报口径 !== 'punch'
                  ? <>
                      ...
                      <Band b="over_out" n={st.异常多记日次} h={st.异常多记小时} m={st.异常多记金额}
                        note="⚠ 唯一必须查的一档：在厂时长撑不起上报的班次，公司可能多付了钱。须业务逐笔说明（实务上多为漏打卡）" />
                    </>
                  : <>
