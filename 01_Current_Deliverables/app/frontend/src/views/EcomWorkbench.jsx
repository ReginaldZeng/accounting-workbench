...
function Overview({data,loading,revision,drill,openCash}) {
  const accounts=useResource('/api/ec/flows/accounts',revision,'accounts'),m=data?.totals
